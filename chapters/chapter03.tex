In the present and in the following chapters the mechanisms of the production of fast particles emitted anisotropically in the laboratory reference frame will be discussed.
...
The cathode wires are made of 80 - 110 $\mu m$ annealed aluminum 
...
The acceptance of the total and each of the sub-detection systems is simulated by the HGeant \cite{HGeant} which is a based on  GEANT3 \cite{brun1993geant} simulation package from CERN. The
...
In this case the maximal momentum at which the signal distribution is considered as  separated from the background is equal to 1500 MeV/c.
 ...
 \begin{figure}[!ht]
   	% Requires \usepackage{graphicx}
   	\centering
  	\includegraphics[width=0.95\textwidth]{Triton_back_per.eps}
...
are shown in fig. \ref{EA_INCL} a, b and c, respectively.
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{EA_ideal}
		\caption{\label{EAideal1} $ideal$ distribution }
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth] {EA_real}
		\caption{\label{EAreal2} $real$ distribution}
		\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{EA_Eff}
...
%Example of "ideal", "real" and resulting $EA$ distributions for protons obtained for combination of INCL++ + HGeant + Hydra frameworks (see below) are presented in fig. \ref{EA_INCL}. 
...
%UrQMDBASS1998,UrQMDBleicher1999}.
...
\begin{figure}[!ht]
	% Requires \usepackage{graphicx}
	\centering
	\includegraphics[width=0.5\textwidth]{MultINCL}
...
%\begin{table}[!ht]
%    \centering
%    \caption{\label{table1} The Minimal and maximum error estimation due to  statistical fluctuations, Efficiency correction, Sector Error(due to different detector gains) and total Systematic error(Sys Error)   }
%    \begin{tabular}{|c|c|c|c|c|c|}
%    \hline
%         &  PID Error & Stat Error & EA Error & Sector Error & Sys Error
%        \\ \hline
%        Max &  44.5\% & 1.5\% & 2\% & %24\% & 45.6\% \\ 
%        Min & 5\% & 0.2\% & 0.16\% & %0\% & 5\% \\  \hline
%    \end{tabular}
%\end{table}
...
%Its usual value varies in the range of 2 - 5\%.
...
The modification of $EA$ due to contribution of secondary particles and thus to the single spectra measured in this work is suppressed by the
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{pearson_1.eps}%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{Protoncross_section_ratio_1.0sigma.eps}%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{ratio_negative.eps}%
...
As it is shown in fig \ref{ratio_pos} and \ref{ratio_neg},   
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{err_cs_proton_1.png}%
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{error_negative.eps}%
    \caption{The example of the distribution of the uncertainty $\sigma_{sec(3)}$ and $\sigma_{sec(6)}$ resulting from the deviation of the results for sector 3 and sector 6..
...
\subsection{\label{consistency_pim} Former HADES results for negatively charged pions
}
